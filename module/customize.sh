...
if [ ! -f ${clash_data_dir}/bin/clashMeta ];then
    ...
    if [ -f "${MODPATH}/bin/clashMeta-android-${ABI}.tar.bz2" ];then
        ...
        mv -f ${clash_data_dir}/bin/clashMeta-android-${ABI} ${clash_data_dir}/bin/clashMeta
    else
...
set_perm  ${clash_data_dir}/bin/clashMeta  ${system_uid}  ${system_gid}  6770
